...
<link href="/admin/static/h-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" action="/shangjia/doLogin.do" method="post">
			<div class="row cl">
