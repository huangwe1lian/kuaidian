 	...
 	$.extend($.fn, {
		...
		_check:function(op) {
			...
			var $input = node.find("a");
                        /*
                         *@author xuesheng
                         *@date 2015��7��27��11:34:02
                         *@desc ��չdwz����js�����ttitle���ԡ��������ṹ���ʡ�ݡ����� || Ʒ�ơ����̵ȶ༶���ṹʱ��
                         *�ύ�?����ɺܶ����õĲ����ύ������ĳЩ������ᳬ�����limit���ơ�
                         *��ps:��ȻhttpЭ������ȷ�涨post�������ޣ�
                         **/
			var tname = $input.attr("tname"), tvalue = $input.attr("tvalue") ,ttitle = $input.attr("ttitle");
			var attrs = "text='"+$input.text()+"' ";
			if (tname) attrs += "name='"+tname+"' ";
			if (tvalue) attrs += "value='"+tvalue+"' ";
			if (ttitle) attrs += "title='"+ttitle+"' ";
