...
public class AlipaySubmit { 
	public static String buildRequest(Map<String, String> paramMap) throws PayException, UnsupportedEncodingException {
		...
		//创建API对应的request  
		AlipayTradeWapPayRequest alipayRequest = new AlipayTradeWapPayRequest(); //支付宝wap支付请求
		//在公共参数中设置异步通地址方法
