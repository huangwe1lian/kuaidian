...
import cn.com.kuaidian.entity.DealerNews;
import cn.com.kuaidian.entity.DealerNewsAddModel;
import cn.com.kuaidian.entity.DealerNewsExt;
import cn.com.kuaidian.entity.DealerNewsModel;
import cn.com.kuaidian.entity.DealerNewsSerialGroup;
import cn.com.kuaidian.entity.DealerNewsText;
import cn.com.kuaidian.entity.PcautoDealerNews;
...
public class DealerNewsSyncController {
	...
	public void dealerNewsSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			SqlBuilder sql;
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news.jsp");
	...
	public void dealerNewsExtSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			String updateStr;
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news_ext.jsp");
				params.append("?pageNo=").append(pageNo++)
				.append("&pageSize=").append(pageSize)
				.append("&startDate=").append(URLEncoder.encode(startDate, "GBK"))
				.append("&endDate=").append(URLEncoder.encode(endDate, "GBK") );
	...
	public void dealerNewsModelSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			JSONObject temp = null;
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news_model.jsp");
				params.append("?pageNo=").append(pageNo++)
				.append("&pageSize=").append(pageSize)
				.append("&startDate=").append(URLEncoder.encode(startDate, "GBK"))
				.append("&endDate=").append(URLEncoder.encode(endDate, "GBK") );
	...
	public void dealerNewsAddModelSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			JSONObject temp = null;
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news_add_model.jsp");
				params.append("?pageNo=").append(pageNo++)
				.append("&pageSize=").append(pageSize)
				.append("&startDate=").append(URLEncoder.encode(startDate, "GBK"))
				.append("&endDate=").append(URLEncoder.encode(endDate, "GBK") );
	...
	public void dealerNewsSerialGroupSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news_serial_group.jsp");
				params.append("?pageNo=").append(pageNo++)
				.append("&pageSize=").append(pageSize)
				.append("&startDate=").append(URLEncoder.encode(startDate, "GBK"))
				.append("&endDate=").append(URLEncoder.encode(endDate, "GBK") );
	...
	public void dealerNewsTextSync(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			JSONObject temp = null;
			do{
				params = new StringBuffer("/dealer/interface/kuaidian/get_dealer_news_text.jsp");
				params.append("?pageNo=").append(pageNo++)
				.append("&pageSize=").append(pageSize)
				.append("&startDate=").append(URLEncoder.encode(startDate, "GBK"))
				.append("&endDate=").append(URLEncoder.encode(endDate, "GBK") );
