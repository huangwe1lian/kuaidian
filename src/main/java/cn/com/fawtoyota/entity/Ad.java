...
public class Ad {
	...
	@Label("广告类型（1:展示,2:专题）")
	@Refer(fieldPath = "adType", type = Select.class)
	private int type;
	
	@Label("活动/专题url")
	private String url;
	
	@Label("广告位置（1:WEB-首页轮播图,2:WEB-车系页轮播图,WEB-车系页本地活动）")
	@Refer(fieldPath = "position", type = Select.class)
	private int position;
	
	@Label("投放平台(1:WEB,2:WAP,3:APP)")
	@Refer(fieldPath = "origin", type = Select.class)
	private int origin;
